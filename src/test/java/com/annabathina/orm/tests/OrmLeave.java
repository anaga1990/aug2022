...
public class OrmLeave {
	...
	public void testLoginOrm() throws InterruptedException {
		...
		if (driver.findElement(By.xpath("//h5[normalize-space()='Leave List']")).isDisplayed()) {
			...
			Thread.sleep(timeOut);
			driver.findElement(By.xpath("//div[@class='oxd-calendar-selector-month-selected']/following-sibling::ul/li[10]")).click();
			Thread.sleep(timeOut);
			//select Date
			driver.findElement(By.xpath("//div[@class='oxd-calendar-date'][text()='9']")).click();
			Thread.sleep(timeOut);
