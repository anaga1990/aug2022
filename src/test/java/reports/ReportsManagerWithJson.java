...
public class ReportsManagerWithJson {
	
	ExtentReports extent;
	ExtentTest extentTest;
	@BeforeSuite
	public void startMyReport() throws IOException {
		//start reports creation
		extent = new ExtentReports(); 
		
		//ExtentSparkReporter template reports need to created
		ExtentSparkReporter spark = new ExtentSparkReporter("target/spark/sparkJson.html");
		
		//Attaching template to Reports generation
		extent.attachReporter(spark);
		final File CONF = new File("./spark-config.json");
